...
public class UserData {
    ...
    public static final String FIRST_NAME = "Cat";
    public static final String LAST_NAME = "Woman";
    public static final String ADDRESS = "Meow street, 0";
    public static final String CITY = "Gotham City";
    public static final String POST_CODE = "10001";
